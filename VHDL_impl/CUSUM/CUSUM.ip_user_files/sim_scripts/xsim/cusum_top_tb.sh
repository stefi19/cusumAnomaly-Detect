...
#
# Script generated by Vivado on Fri Dec 05 09:34:38 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cusum_top_tb.sh
...
#
# Usage        : cusum_top_tb.sh
#                cusum_top_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cusum_top_tb.sh [-reset_run]
#                cusum_top_tb.sh [-reset_log]
#                cusum_top_tb.sh [-help]
#
...
# script info
echo -e "cusum_top_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cusum_top_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_15 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot cusum_top_tb xil_defaultlib.cusum_top_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cusum_top_tb -key {Behavioral:sim_1:Functional:cusum_top_tb} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm axis_infrastructure_v1_1_1 axis_data_fifo_v2_0_15)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cusum_top_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cusum_top_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cusum_top_tb.sh [-help]\n\
Usage: cusum_top_tb.sh [-step]\n\
Usage: cusum_top_tb.sh [-lib_map_path]\n\
Usage: cusum_top_tb.sh [-reset_run]\n\
Usage: cusum_top_tb.sh [-reset_log]\n\
Usage: cusum_top_tb.sh [-keep_index]\n\
Usage: cusum_top_tb.sh [-noclean_files]\n\n\
