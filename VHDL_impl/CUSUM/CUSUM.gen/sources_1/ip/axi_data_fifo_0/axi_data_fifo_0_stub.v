...
//               5/cusumAnomaly-Detect/VHDL_impl/CUSUM/CUSUM.gen/sources_1/ip/axi_data_fifo_0/axi_data_fifo_0_stub.v}
...
(* CHECK_LICENSE_TYPE = "axi_data_fifo_0,axi_data_fifo_v2_1_32_axi_data_fifo,{}" *) (* CORE_GENERATION_INFO = "axi_data_fifo_0,axi_data_fifo_v2_1_32_axi_data_fifo,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_data_fifo,x_ipVersion=2.1,x_ipCoreRevision=32,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_FAMILY=artix7,C_AXI_PROTOCOL=0,C_AXI_ID_WIDTH=1,C_AXI_ADDR_WIDTH=32,C_AXI_DATA_WIDTH=32,C_AXI_SUPPORTS_USER_SIGNALS=0,C_AXI_AWUSER_WIDTH=1,C_AXI_ARUSER_WIDTH=1,C_AXI_WUSER_WIDTH=1,C_AXI_RUSER_WIDTH=1,C_AXI_BUSER_WIDTH=1,C_AXI_WRITE_FIFO_DEPTH=0,C_AXI_WRITE_FIFO_TYPE=lut,C_AXI_WRITE_FIFO_DELAY=0,C_AXI_READ_FIFO_DEPTH=0,C_AXI_READ_FIFO_TYPE=lut,C_AXI_READ_FIFO_DELAY=0}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
